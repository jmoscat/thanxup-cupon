...
#curl -v -H "Accept: application/json" -H "Content-type: application/json" -X POST -d '{"user_id":"1220884986", "update_stamp":"2012-08-13 06:25:36 UTC"}' http://localhost:3000/api/getcupons.json
  def getcupons
